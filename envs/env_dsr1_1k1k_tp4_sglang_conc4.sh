...
# Configuration for SGLang with CONC=4
...
# Result filename
export RESULT_FILENAME="dsr1_fp4_b200_sglang_1k1k_tp4_conc4"
...
echo "Environment variables set for DeepSeek R1 FP4 on B200 with SGLang"
echo "================================================"
echo "Model: $MODEL"
echo "Image: $IMAGE"
