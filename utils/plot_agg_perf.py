...
# Load aggregated JSON file instead of directory
agg_file = Path(sys.argv[1])
exp_name = sys.argv[2] if len(sys.argv) > 2 else agg_file.stem
...
# Load results from single aggregated JSON file
...
for model_family in model_families:
    ...
    # Create plot for this model family
